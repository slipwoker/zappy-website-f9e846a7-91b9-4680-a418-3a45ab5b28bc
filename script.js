    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בית קפה בעלמא משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f9e846a7-91b9-4680-a418-3a45ab5b28bc',
                    name: data.name || '',
                    email: data.email || '',
